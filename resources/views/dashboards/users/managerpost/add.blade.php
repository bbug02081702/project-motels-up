...
@section('content')
<h1 class="text-center"> Dang tin phong tro </h1>
<div class="container">
      <div class="card">
        <div class="card-body">
          ...
          @endif
              <form action="{{route('user.poststore')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="name" class="form-label">Ten lien he</label>
                    <input type="text" name="name" class="form-control" id="" placeholder="Nhap ten lien he">
                </div>
                <div class="mb-3">
                ...
                <a href="{{route('user.post')}}" type="button" class="btn btn-success">Tro ve</a>
              </form>
          </div>
        </div>
      </div>
